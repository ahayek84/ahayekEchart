...
$vBook2 = new SBook();
$vBook2-> setID(1);
$vBook2-> setName("HUNGER SERVICE");
$vBook2-> setPrice(10);
$vBook2-> setStartDT("10/10/2010");
$vBook2-> setEndDT("10/10/2015");
?>

<?php
$vEChart = new EChart();
$vEChart-> addBook($vBook2,'1');
$vEChart-> addBook($vBook,'2');
?>
...
<?php
/*$res = $vBook-> getID() ." ". $vBook-> getName() ." ".$vBook-> getPrice();
print $res ;*/
?>

<?php
/*$res = $vBook2-> getID() ." ". $vBook2-> getName() ." ".$vBook2-> getPrice()
." ".$vBook2-> getStartDT()." ".$vBook2-> getEndDT();
print $res ;*/
?>
